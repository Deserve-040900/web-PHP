...
class xu_ly_loai_sach extends data {
    ...
    function recursion_lay_toan_bo_con(&$ds_loai_cha){
    ...
    function print_tat_ca_loai_sach_theo_cha($ds_loai_cha){
        foreach($ds_loai_cha as $item_loai_cha){
            ...
            <li class="dropdown-submenu">
                <a href="/MyProject-master/do_an_09-14/?page=loai-sach&id_loai_sach=<?php echo $item_loai_con->id ?>"><?php echo $item_loai_cha->$ten_loai_sach ?></a>
        ...
        if(count($item_loai_cha->ds_con)){
            ...
            <ul class="dropdown-menu hidden-xs hidden-sm">
                ...
                foreach($item_loai_cha->ds_con as $item_loai_con){
                    ?>
                    <li class="dropdown-submenu">
                        <a href="/MyProject-master/do_an_09-14/?page=loai-sach&id_loai_sach="<?php echo $item_loai_con->id ?>><?php echo $item_loai_con->$ten_loai_sach ?></a>
