            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal"><?php echo $thong_tin_user->ho_ten ?></h5>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo $thong_tin_user->ho_ten ?></p>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              <span class="pl-2"><?php echo $thong_tin_user->ho_ten ?></span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Dashboard </td>
