    ...
    if($id_xoa){
        ...
        if($result){
            ...
            <script>
                ...
                window.location.href = '/MyProject-master/do_an_09-14/admin/?page=sach';
            </script>
            <?php
        }
    }
            ...
            function function_build_html(data_list){
                ...
                for(var i=0;i<data_list.length;i++){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/MyProject-master/do_an_09-14/admin/?page=sach&id_xoa=${data_list[i].id}" type="button" 
                                    class="btn btn-danger" onclick="recheck_delete()">
            ...
            $(function() {
                $('#simplePagination').pagination({
                    ...
                    onPageClick: function(pageNumber) {
                        ...
                        $.get('http://localhost/MyProject-master/do_an_09-14/admin/api.php?trang=' + (pageNumber-1))
                            .done(data) => {
